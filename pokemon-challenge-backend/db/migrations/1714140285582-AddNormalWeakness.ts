...
export class AddNormalWeakness1714140285582 implements MigrationInterface {
    name = 'AddNormalWeakness1714140285582'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."pokemon_type_enum" RENAME TO "pokemon_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."pokemon_type_enum" AS ENUM('Fire', 'Ice', 'Water', 'Grass', 'Poison', 'Flying', 'Psychic', 'Fighting', 'Ground', 'Rock', 'Electric', 'Bug', 'Normal')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pokemon_weaknesses_enum" AS ENUM('Fire', 'Ice', 'Water', 'Grass', 'Poison', 'Flying', 'Psychic', 'Fighting', 'Ground', 'Rock', 'Electric', 'Bug', 'Normal')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."pokemon_weaknesses_enum_old" AS ENUM('Fire', 'Ice', 'Water', 'Grass', 'Poison', 'Flying', 'Psychic', 'Fighting', 'Ground', 'Rock', 'Electric', 'Bug')`);
        await queryRunner.query(`ALTER TABLE "pokemon" ALTER COLUMN "weaknesses" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."pokemon_type_enum_old" AS ENUM('Fire', 'Ice', 'Water', 'Grass', 'Poison', 'Flying', 'Psychic', 'Fighting', 'Ground', 'Rock', 'Electric', 'Bug')`);
        await queryRunner.query(`ALTER TABLE "pokemon" ALTER COLUMN "type" DROP DEFAULT`);
